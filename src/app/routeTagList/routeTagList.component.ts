...
export class RouteTagListComponent {
  routeTags: RouteTag[] = [
    new RouteTag('boulder', 'blue', 'I am sleepy', '4', null, '2/12/18', 'CL', null, null, null),
    new RouteTag('rope', 'purple', 'Need to take a nap', '11', 'c', '2/12/18', 'CL', 'TR and Lead', 58, null)
  ];

  printTags: RouteTag[] = [
    new RouteTag('boulder', 'blue', 'I am sleepy', '4', null, '2/12/18', 'DG', null, null, null),
